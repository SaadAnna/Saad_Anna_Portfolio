    ...
    <section className="py-20">
      <div className="container">
        <div className="flex flex-col gap-10 mx-auto">
          ...
          <div className="text-3xl max-w-4xl text-neutral-500 cursor-pointer font-normal mx-auto text-center duration-300 ease-linear hover:text-neutral-300 ">
          <span className="text-white font-medium mx-auto text-center text-4xl max-w-4xl" >Hello, I&apos;m Saad</span>
          ...
          <span className="text-white font-medium mx-auto text-center text-4xl max-w-4xl">{' '}Let’s build something amazing together!</span>
          </div>
        </div>  
      </div>
    </section>
